...
export function Button({ children, startIcon, endIcon, className = '', type, onClick }: Props) {
    return (
        <button
            ...
            hover:border-tamarillo focus:border-tamarillo active:border-tamarillo transition-all
                ${className}
            `}
            onClick={onClick}
        >
            <div className='w-full text-white text-sm sm:text-sm md:text-base lg:text-lg 
